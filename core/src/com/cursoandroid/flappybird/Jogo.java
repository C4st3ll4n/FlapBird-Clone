...
public class Jogo extends ApplicationAdapter {
    ...
    */
    ...
    private void desenharTexturas(){
        ...
        batch.draw( passaros[ (int) variacao] ,50,posicaoInicialVerticalPassaro + posicaoHorizontalPassaro);
        ...
        if( estadoJogo == 2 ){
            ...
            textoMelhorPontuacao.draw(batch, "Seu record é: "+pontuacaoMaxima + " ponto(s)", larguraDispositivo/2 -140,alturaDispositivo/2 - gameOver.getHeight());
    ...
    private void inicializaObjetos(){
        ...
        preferences = Gdx.app.getPreferences("passarineo_recorde");
